...
Prompting Reject busy requests Markdown Conversion Beta Overview Usage Workers Binding REST API Supported Formats How it works Conversion Options Guides Demos and architectures Tutorials Agents ↗ Platform Pricing Data usage Limits Glossary AI Gateway ↗ Errors Choose a data or storage product ↗ Event subscriptions Agents ↗ Playground Changelog REST API reference ↗ API Agent resources Agent setup ↗ Cloudflare Skills ↗ Code Mode MCP Server ↗ Domain-specific MCP Servers ↗ MCP Workers AI llms.txt ↗ Workers AI llms-full.txt ↗ Cloudflare Docs llms.txt ↗ Cloudflare Docs llms-full.txt ↗ Home / Workers
AI / Changelog Changelog Last updated Apr 21, 2026 | Copy as Markdown | View as Markdown | Agent setup Subscribe to RSS 2026-06-16 GLM-5.2 now available on Workers AI @cf/zai-org/glm-5.2 is now available on Workers AI.
